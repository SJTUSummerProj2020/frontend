          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item
                ...
                label="商品ID"
              >
                <Input placeholder="商品ID" disabled />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            ...
            <Col span={8}>
              <Form.Item
                ...
                label="演出时间"
              >
                <Input placeholder="演出时间" disabled />
              </Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item
                ...
                label="票档ID"
              >
                <Input placeholder="票档ID" disabled />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                label="拍卖ID"
              >
                <Input placeholder="拍卖ID" disabled />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
